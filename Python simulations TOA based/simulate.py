...
time_axis, data = read_csv_data("received_data.csv")
...
slider_ref = Slider(ax_ref, 'Ref Cells', 50, 5000, valinit=initial_ref_cells, valstep=10)
...
def update(val):
    ...
    targets_scatter.set_offsets(np.column_stack((time_axis, targets_only)))
